...
const translations = {
  zh: {
    ...
    "pillar2.slot1.label": "⚡️ 首窗激活",
    "pillar2.slot2.time": "12:00",
    "pillar2.slot2.label": "🔄 满血重置",
    "pillar2.slot3.time": "17:00",
    "pillar2.slot3.label": "🚀 再次重置",
  ...
  en: {
    ...
    "pillar2.slot1.time": "07:00",
    "pillar2.slot1.label": "⚡️ Activate (W1)",
    "pillar2.slot2.time": "12:00",
    "pillar2.slot2.label": "🔄 Reset (W2)",
    "pillar2.slot3.time": "17:00",
    "pillar2.slot3.label": "🚀 Reset (W3)",
...
// Strings added for the interactive demos and the DMG download card.
Object.assign(translations.zh, {
  ...
  "x.stSend": "派发中",
  "x.stLive": "窗口 #1 计时中",
  "x.seq1": "RTC 硬件唤醒 · IOPMSchedulePowerEvent",
  "x.seq2": "Wi-Fi 握手完成 · NetworkMonitor",
  "x.seq3": "codex exec → 发送激活消息「嗨」",
  "x.seq4": "5H 窗口 #1 开始 · 12:00 重置",
  "x.qTitle": "待发队列",
  "x.replay": "重播",
  "x.qRemain": "5H 剩余",
  "x.qReset": "解封倒计时",
  ...
  "x.qSending": "派发中",
  "x.qSent": "已发送",
  "x.dTitle": "拖动：今天第一条消息几点发？",
  "x.dReset": "用 07:00 激活",
  "x.dFirst": "首条消息",
  "x.dCount": "22:00 前可用满的窗口",
  "x.dlMeta": "Universal · macOS 14 及以上",
  "x.dlBtn": "下载 DMG",
  "x.dlNote": "Developer ID 签名并经 Apple 公证。打开后把 Next5h 拖进「应用程序」即可。"
});
...
Object.assign(translations.en, {
  ...
  "x.stLive": "Window #1 running",
  "x.seq1": "RTC hardware wake · IOPMSchedulePowerEvent",
  "x.seq2": "Wi-Fi handshake done · NetworkMonitor",
  "x.seq3": "codex exec → send activation prompt \"hi\"",
  "x.seq4": "5H window #1 starts · resets 12:00",
  "x.qTitle": "Queue",
  "x.replay": "Replay",
  "x.qRemain": "5H left",
  "x.qReset": "Resets in",
  ...
  "x.qSending": "Sending",
  "x.qSent": "Sent",
  "x.dTitle": "Drag: when do you send your first message?",
  "x.dReset": "Activate at 07:00",
  "x.dFirst": "First message",
  "x.dCount": "Full windows before 22:00",
  "x.dlMeta": "Universal · macOS 14 or later",
  "x.dlBtn": "Download DMG",
  "x.dlNote": "Developer ID signed and notarized by Apple. Open it and drag Next5h into Applications."
});
